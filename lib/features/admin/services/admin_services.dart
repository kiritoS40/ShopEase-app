import 'dart:convert';
import 'dart:io';
import 'package:shopease/constants/error_handling.dart';
import 'package:shopease/constants/global_variables.dart';
import 'package:shopease/features/admin/models/sales.dart';
...
class AdminServices {
  void sellProducts({
    ...
    try {
      final cloudinary = CloudinaryPublic('dnkkh5vuz', 'ntsnefvi');
