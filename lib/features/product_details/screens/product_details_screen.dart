...
import 'package:shopease/features/account/services/account_services.dart';
...
import 'package:shopease/common/widgets/custom_elevated_button.dart';
import 'package:shopease/common/widgets/stars.dart';
import 'package:shopease/features/home/widgets/custom_carousel_slider.dart';
import 'package:shopease/features/product_details/services/product_details_services.dart';
      ...
      children: [
        ...
        RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(
                text: 'from Php $emi. No Cost EMI available.',
                style: const TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.normal,
                  color: Colors.black,
